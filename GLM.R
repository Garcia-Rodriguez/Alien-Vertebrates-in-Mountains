###GLMM Alien vertebrates in Mountains of the World
...
setwd("your_path") ##Set the path in your machine
...
##Cross-taxonomic model (All data combined)
...
summary(mod_neg.bi) # n= 2696 mountains
...
summary(mod_neg.bi.fish) # n= 722 mountains
...
summary(mod_neg.bi.amphs) # n= 429 mountains
...
summary(mod_neg.bi.repts) # n= 498 mountains
...
summary(mod_neg.bi.birds) # n= 2424 mountains
...
summary(mod_neg.bi.mamms) # n= 1549 mountains
